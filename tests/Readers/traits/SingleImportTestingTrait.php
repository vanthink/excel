...
trait SingleImportTestingTrait {
    ...
    public function testGet()
    {
        ...
        $this->assertInstanceOf('Vanthink\Excel\Collections\RowCollection', $got);
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('Vanthink\Excel\Collections\RowCollection', $all);
    ...
    public function testFirst()
    {
        ...
        $this->assertInstanceOf('Vanthink\Excel\Collections\CellCollection', $first);
    ...
    public function testEach()
    {
        ...
        $this->loadedFile->each(function($cells) use($me) {
            ...
            $me->assertInstanceOf('Vanthink\Excel\Collections\CellCollection', $cells);
    ...
    public function testByConfig()
    {
        ...
        $this->assertInstanceOf('Vanthink\Excel\Collections\SheetCollection', $config);
    }
    ...
    public function testByConfigCallback()
    {
        ...
        {
            $me->assertInstanceOf('Vanthink\Excel\Readers\ConfigReader', $config);
        });
