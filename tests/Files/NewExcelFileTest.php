...
class NewExcelFileTest extends TestCase {
    ...
    public function testInit()
    {
        ...
        $this->assertInstanceOf('Vanthink\Excel\Files\NewExcelFile', $exporter);
    }
    ...
    public function testCreateNewFile()
    {
        ...
        $this->assertInstanceOf('Vanthink\Excel\Writers\LaravelExcelWriter', $exporter->getFileInstance());
    }
