...
class ExcelTestCase extends PHPUnit_Framework_TestCase {
    ...
    {
        $this->assertInstanceOf('Vanthink\Excel\Excel', $this->excel);
    }
    ...
    {
        $this->phpexcel = m::mock('Vanthink\Excel\Classes\PHPExcel');
    ...
    {
        $this->reader = m::mock('Vanthink\Excel\Readers\LaravelExcelReader');
    ...
    {
        $this->writer = m::mock('Vanthink\Excel\Writers\LaravelExcelWriter');
    ...
    {
        $this->batch = m::mock('Vanthink\Excel\Readers\Batch');
