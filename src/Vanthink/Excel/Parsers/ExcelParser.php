...
use Vanthink\Excel\Collections\RowCollection;
use Vanthink\Excel\Collections\CellCollection;
use Vanthink\Excel\Collections\SheetCollection;
...
class ExcelParser {
     ...
     * @return \Vanthink\Excel\Parsers\ExcelParser
     */
