<?php namespace Vanthink\Excel\Readers;
...
use Vanthink\Excel\Parsers\ExcelParser;
use Vanthink\Excel\Classes\FormatIdentifier;
use Vanthink\Excel\Exceptions\LaravelExcelException;
...
class LaravelExcelReader {
     ...
     * @param  $separator
     * @return \Vanthink\Excel\Readers\LaraveExcelReader
     */
